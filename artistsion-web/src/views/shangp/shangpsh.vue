        ...
        <el-card>
            <el-table :data="List" stripe style="width: 100%">
                ...
                <el-table-column label="操作" width="280">
                    <template slot-scope="scope">
                        <el-button type="primary" v-if="scope.row.status==='未审核'"  @click="openEditUI(scope.row.id,'审核成功')">审核成功</el-button>
                      <el-button type="danger" v-if="scope.row.status==='未审核'"  @click="openEditUI(scope.row.id,'审核失败')">审核失败</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </el-card>

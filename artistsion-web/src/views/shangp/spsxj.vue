      ...
      <el-card>
          <el-table :data="List" stripe style="width: 100%">
              ...
              <el-table-column label="操作" width="180">
                  <template slot-scope="scope">
                      <el-button type="primary" v-if="scope.row.type==='下架'"  @click="openEditUI(scope.row.id,'上架')">上架</el-button>
                      <el-button type="danger" v-if="scope.row.type==='上架'"  @click="openEditUI(scope.row.id,'下架')">下架</el-button>
                  </template>
              </el-table-column>
          </el-table>
      </el-card>

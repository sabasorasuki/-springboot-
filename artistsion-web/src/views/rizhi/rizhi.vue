<template>
    <div>
        ...
        <el-card id="search">
            <el-row>
                <el-col :span="20">
                    <el-input v-model="searchModel.rizhi" placeholder="日志内容" clearable></el-input>
        ...
        <el-dialog @close="clearForm" :title="title" :visible.sync="dialogFormVisible">
            <el-form :model="Form" :rules="rules" ref="FormRef">
                <el-form-item label="日志内容" :label-width="formLabelWidth">
                    <el-input v-model="Form.rizhi" type="textarea" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="操作时间" :label-width="formLabelWidth">
                    <el-input v-model="Form.jldate" readonly autocomplete="off"></el-input>
                </el-form-item>

    ...
    <el-card class="mail-form-card">
      <el-form :model="form" label-width="100px">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="折扣/元">
              <el-input v-model="form.zhekou" autocomplete="off" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="备注">
              <el-input v-model="form.fujin" type="textarea" autocomplete="off" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="分类">
              <el-select v-model="form.fenlei" style="width: 100%" clearable placeholder="请选择分类">
                <el-option
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="状态">
              <el-select v-model="form.type" placeholder="请选择状态" style="width: 100%;">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item>
              <el-button type="primary" @click="saveOrUpdate()">发布画稿</el-button>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
  ...
  methods: {
    loadAllClasses() {
      ...
      fenleiApi.getList1().then(response => {
        ...
        const tmp = response.data.rows// 将表单信息提
    ...
    getInfo(token) {
      userApi.getInfo(token).then(response => {
        ...
        this.form.shangjiaids = this.forms.id

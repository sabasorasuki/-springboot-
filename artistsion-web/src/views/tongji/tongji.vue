    ...
    <el-row :gutter="20">
      ...
      <el-col :span="12">
        <el-card>
          ...
          <div id="amountLineChart" style="width: 100%; height: 400px;" />
        </el-card>
      </el-col>
      ...
      <el-col :span="12">
        <el-card>
          ...
          <div id="countBarChart" style="width: 100%; height: 400px;" />
        </el-card>
      </el-col>
    </el-row>
    ...
    <el-row :gutter="20" style="margin-top: 20px;">
      ...
      <el-col :span="12">
        <el-card>
          ...
          <div id="userBarChart" style="width: 100%; height: 400px;" />
        </el-card>
      </el-col>
    </el-row>
    ...
    <el-row :gutter="20" style="margin-top: 20px;">
      ...
      <el-col :span="24">
        <el-card>
          ...
          <div id="productBarChart" style="width: 100%; height: 400px;" />
        </el-card>
      </el-col>
    </el-row>
  </div>

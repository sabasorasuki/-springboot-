<template>
    <div>
        ...
        <el-card id="search">
            <el-row>
                <el-col :span="20">
                    <el-input v-model="searchModel.name" placeholder="画稿名字" clearable></el-input>
            ...
            <el-table :data="List" stripe style="width: 100%">
                ...
                <el-table-column label="操作" width="280">
                    <template slot-scope="scope">
                        <el-button type="primary"  v-if="scope.row.status =='已发货'" @click="openEditUI(scope.row.id)" >确认收货并评价</el-button>
        ...
        <!-- 用户信息编辑对话框 -->
        <el-dialog @close="clearForm" title="评价" :visible.sync="dialogFormVisible">
            <el-form :model="Form" :rules="rules" ref="FormRef">
                ...
                <el-form-item label="价格" :label-width="formLabelWidth" >
                    <el-input v-model="Form.price" readonly autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="评价" :label-width="formLabelWidth" >
                        <el-select v-model="Form.pingjia" placeholder="请选择评价">
                        <el-option label="推荐" value="15"></el-option>
                        <el-option label="一般" value="10"></el-option>
                        <el-option label="不推荐" value="5"></el-option>
                        </el-select>
                </el-form-item>

          ...
          <div class="article-container">
            <div class="article-header">
              ...
              <div class="article-meta">
                <div class="meta-item">
                  <i class="fa fa-user"></i> {{ email.username }}
                </div>
                <div class="meta-item">
                  <i class="fa fa-calendar"></i> {{ email.fbdate }}
                </div>
                <div class="meta-item">
                  <i class="fa fa-thumbs-up"></i> {{ email.dznum }} 赞
                </div>
              </div>
            </div>
            <div class="article-content" v-html="email.content"></div>
          </div>
        </el-col>

...
@RestController
@RequestMapping("/recHuagao")
public class RecHuagaoRecommendationController {

    @Resource
    private RecHuagaoRecommendationService recommendationService;
    ...
    public Result<Map<String, Object>> recommendations(
        ...
        return Result.success(recommendationService.getRecommendations(
                userId,
